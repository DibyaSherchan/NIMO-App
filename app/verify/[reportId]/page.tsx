      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-xl p-6">
          ...
          <p className="text-gray-600 mb-6">
            Upload the PDF file to verify its authenticity and ensure it
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-red-700">
                        The PDF document has been modified or is not authentic.
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <details className="cursor-pointer">
                ...
                <div className="mt-4 space-y-2 text-sm text-gray-600 bg-gray-50 p-4 rounded">
                  <p>
                    <span className="font-semibold">Verification Method:</span>{" "}
        ...
        <div className="mt-6 text-center text-sm text-gray-600 bg-white rounded-lg shadow p-4">
          ...
          <p>
            This page verifies the authenticity of medical reports issued by
            Nippon Medical Centre Pvt. Ltd. The QR code on the original report
